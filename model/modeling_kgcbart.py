...
import random
import warnings
from typing import List, Optional, Tuple, Union, Dict, Callable, Iterable, Any
...
class BartEncoder(BartPretrainedModel):
    ...
    def __init__(self, config: BartConfig, embed_tokens: Optional[nn.Embedding] = None, embed_entitys=None, embed_relations=None):
...
class KGCBartModel(BartPretrainedModel):
...
class KGCBartForConditionalGeneration(BartPretrainedModel):
    base_model_prefix = "model"
    ...
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        return {
            ...
            "input_entity_ids": kwargs.get("input_entity_ids"),
            "word_mask": kwargs.get("word_mask"),
            "encoder_outputs": encoder_outputs,
            "past_key_values": past_key_values,
            "decoder_input_ids": decoder_input_ids,
            "attention_mask": attention_mask,
