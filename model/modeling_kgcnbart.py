...
class KGCNBartModel(BartPreTrainedModel):
...
class KGCNBartForConditionalGeneration(BartPreTrainedModel):
    base_model_prefix = "model"
...
class KGCNBartForSequenceClassification(BartPreTrainedModel):
    ...
    def forward(
        ...
        d = c[:, -1, :]
        sentence_representation = hidden_states[eos_mask, :].view(a, -1, b)[
            :, -1, :
        ]
